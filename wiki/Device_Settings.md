...
-   device settings (as provided, colour relevant ones should be
    queryable by a device driver API)

  
expl. PPD, scan parameters, VCGT

-   -   fixing colour sensible driver settings is a precondition to form
        a calibration
...
-   distribute by combining above information
    -   packing all informations into one pice

  
embedd into ICC profile, register in a local or remote hardware db, xml
configuration
